03/05/2019:
  ...
  Usage:
directly use the HIRAS measured channel radiances (2275, Ndata) multiple(matrix multiple) HIRAS gap channel prediction coefficients P and plus the constant C in each gap channels
    HIRAS_RAD(gap) = HIRAS_RAD(measure) ## P + C
